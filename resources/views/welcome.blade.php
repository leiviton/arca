...
<section class="main-header">
            <div id="owl-herosm" class="owl-carousel owl-theme hidden-lg hidden-md" style="margin-top: 80px;">
                <div class="item" style="background-image: url({{ URL::asset('theme/img/sliders/5sm.png') }})">
                    <!--div class="caption">
                ...
                <div class="item" style="background-image: url({{ URL::asset('theme/img/sliders/3sm.png') }})">
                    <!--div class="caption">
                        <h6>Branding / Design / Creativty</h6>
                        <h1>We Are <span>Rise</span></h1>
                        <a class="btn btn-transparent" href="#">Learn More</a><a class="btn btn-light" href="#">Buy Now</a>
                ...
                <div class="item" style="background-image: url({{ URL::asset('theme/img/sliders/6sm.png') }})">
                    <!--div class="caption">
                        <h6>Branding / Design / Creativty</h6>
                        <h1>We Are <span>Rise</span></h1>
                        <a class="btn btn-transparent" href="#">Learn More</a><a class="btn btn-light" href="#">Buy Now</a>
            ...
            <div id="owl-hero" class="owl-carousel owl-theme hidden-sm hidden-xs">    
