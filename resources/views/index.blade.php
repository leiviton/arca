        ...
        <section id="team">
            <div class="container">
                ...
                <div class="row wow fadeInUp" data-wow-delay=".3s">
                    <div class="col-md-4">
                        <div class="team">
                            <img class="img-responsive center-block" src="{{ URL::asset('theme/img/team/MariaDoe.jpg') }}" alt="1">
                            <h4>Maria Doe</h4>
                            <p>Designer</p>
                    ...
                    <div class="col-md-4">
                        <div class="team">
                            <img class="img-responsive center-block" src="{{ URL::asset('theme/img/team/JasonDoe.jpg') }}" alt="2">
                            <h4>Jason Doe</h4>
                            <p>Developer</p>
                            <div class="team-social-icons">
                                <a href="#"><i class="fa fa-facebook"></i></a>
                    ...
                    <div class="col-md-4">
                        <div class="team">
                            <img class="img-responsive center-block" src="{{ URL::asset('theme/img/team/MikeDoe.jpg') }}" alt="3">
                            <h4>Mike Doe</h4>
                            <p>Photographer</p>
                            <div class="team-social-icons">
                                <a href="#"><i class="fa fa-facebook"></i></a>
